...
import { MessageCircle, Send, Zap, Clock, Users, TrendingUp, Loader2 } from 'lucide-react'
...
const ScoutAIChat: React.FC<ScoutAIChatProps> = ({ className = '', onInsightGenerated }) => {
  ...
  useEffect(() => {
    ...
    const welcomeMessage: ChatMessage = {
      id: 'welcome',
      type: 'assistant',
      content: 'Hi! I\'m Scout AI, your analytics assistant. I can help you analyze customer behavior, sales patterns, and store performance. Try asking about peak shopping hours, basket analysis, or demographic trends.',
      timestamp: new Date()
    }
  ...
  return (
    <div className={`scout-card flex flex-col h-96 ${className}`}>
      {/* Header */}
